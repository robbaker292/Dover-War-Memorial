...
Click the \textit{Admin} button in the middle left of the top bar. It should redirect to a page entitled \texttt{Admin}, which has very little content at present.

\test{Does the meta pages button work?}
Click the \textit{Meta Pages} button in the middle right of the top bar. It should redirect to a page entitled \texttt{Meta Pages}, which has very little content at present.
...
\test{Are the Edit/New buttons removed when logged out (1)?}

\test{Are the Edit buttons removed when logged out (2)?}
