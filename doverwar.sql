...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2017 at 12:47 PM
...
(4, 'aaatitle', 'some text edited\r\nsme more text', '2017-02-03', 1),
...
CREATE TABLE `casualty` (
  ...
  `unsure_details` tinyint(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Truncate table before insert `change_log`
--
...
INSERT INTO `change_log` (`id`, `change_type`, `item_id`, `description`, `date`) VALUES
(1, 1, 1, 'testing', '2017-05-18 19:37:28'),
(2, 1, 1, 'testing 2', '2017-05-18 19:47:51'),
(3, 1, 1, 'testing 3', '2017-05-18 19:49:55'),
(7, 2, 4, 'Log long description about this article', '2017-05-18 20:31:09'),
(8, 3, 6, 'testing site updates!', '2017-05-18 20:34:46'),
(9, 3, 6, 'testing 4', '2017-05-18 20:36:00'),
(10, 4, 0, 'testing 6', '2017-05-18 20:44:23'),
(11, 4, 0, 'Memorial narrative added', '2017-05-19 10:57:53');
...
--
-- Truncate table before insert `change_type`
--

TRUNCATE TABLE `change_type`;
--
...
INSERT INTO `commemoration_location` (`id`, `name`, `narrative`, `location`, `lat`, `lon`, `mainOrder`) VALUES
(1, 'Dover War Memorial', 'The big one in Dover', 'On the High Street', 51.127998, 1.309245, 1),
(2, 'Book of Remembrance', 'They were all casualties of World War II.', NULL, NULL, NULL, 2),
(3, 'Testing', 'Not main', NULL, NULL, NULL, NULL);
...
('admin', 'Admin', 'This is the admin page\r\n\r\nLink to all the other meta [pages](../listAll)', 'Main admin page'),
...
('memorialIndex', 'Memorial Index', '> Little did my mother think,\r\n> \r\n> The day she cradled me,\r\n> \r\n> What land I was to travel in,\r\n> \r\n> What death I was to die.', 'On the memorial index page'),
...
DROP TABLE IF EXISTS `picture_site_update`;
...
DROP TABLE IF EXISTS `site_update`;
...
(6, 'Title 2017 test', 'more text here _test_ update.\r\n\r\nZeebrugge\r\n', '2017-02-26', 0),
...
INSERT INTO `user_token` (`token`, `end`) VALUES
('220bfffa5db4fd614b115e2d4a94cf6b7bb5d34e', '2017-05-19 17:45:00');
...
--
ALTER TABLE `change_log`
  ADD CONSTRAINT `con_change_type` FOREIGN KEY (`change_type`) REFERENCES `change_type` (`id`);
