...
\marker{4}    & Bullet List    & \begin{tabular}[c]{@{}l@{}}\texttt{- item 1}\\\texttt{- item 2}\end{tabular}                                                                                                      &   \includegraphics[scale=0.8]{pics/list.png}   \\
\marker{5}    & Numbered List  & \begin{tabular}[c]{@{}l@{}}\texttt{1. item 1}\\\texttt{2. item 2}\end{tabular}                                                                                                    &   \includegraphics[scale=0.8]{pics/number.png}   \\
